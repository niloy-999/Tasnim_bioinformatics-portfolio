...
import { GraduationCap, Briefcase, Sparkles, Compass, CheckCircle2, Award, Calendar, MapPin } from "lucide-react";
...
export const metadata: Metadata = {
  title: "About",
  description: "Academic background, research experience, and scientific focus of Tasnim Ul Islam."
};
  ...
  return (
    <Container className="py-12 sm:py-16">
      <SectionHeading
        ...
        title="Who I Am"
        description="Final-year Bioinformatics Engineering student at Bangladesh Agricultural University, focusing on computational genomics and biological sequence learning."
      />

      {/* Main Narrative - Justified & Well-Structured */}
      <div className="mt-8 space-y-4 rounded-2xl border border-line/80 bg-white/75 p-6 shadow-sm backdrop-blur-md dark:border-line-dark/80 dark:bg-slate-900/60 sm:p-8">
        <p className="text-justify text-sm leading-relaxed text-ink-700 dark:text-ink-200 sm:text-base sm:leading-8">
          I am a final-year Bioinformatics Engineering student at Bangladesh Agricultural
          University, working at the intersection of computational genomics, evolutionary
          biology, and machine learning. Over the past year, my work has spanned three core
          domains: reference-guided whole-genome assembly and functional annotation, complete
          mitochondrial genome and population-genetic analysis of commercially important
          Bangladeshi fish species, and a DNA–protein cross-modal deep learning framework designed
          for discovering plastic-degrading genes in bacteria.
        </p>

        <p className="text-justify text-sm leading-relaxed text-ink-700 dark:text-ink-200 sm:text-base sm:leading-8">
          I am drawn to research problems where computational methods can meaningfully narrow down
          what a wet laboratory needs to experimentally validate — prioritizing candidate genes,
          flagging hidden population structures worth sampling further, or generating reference
          assemblies where none previously existed. I adhere strictly to scientific transparency:
          in silico predictions represent rigorous hypotheses to be experimentally challenged,
          not final biological conclusions.
        </p>
      </div>
          ...
          <div className="flex h-full flex-col rounded-2xl border border-line/80 bg-white/75 p-6 shadow-sm backdrop-blur-sm dark:border-line-dark/80 dark:bg-slate-900/60 sm:p-7">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-ink-500 dark:text-cyan-300/80">
                  Undergraduate & Pre-University Education
                </p>
              </div>
            </div>
            ...
            <div className="mt-5 space-y-4">
              <div className="rounded-xl border border-line/70 bg-paper/60 p-4 dark:border-line-dark/70 dark:bg-slate-800/50">
                ...
                <p className="mt-1 text-xs text-ink-600 dark:text-ink-300">{site.institution}</p>
              ...
              <div className="rounded-xl border border-line/70 bg-paper/60 p-4 dark:border-line-dark/70 dark:bg-slate-800/50">
                ...
                <div className="mt-2 space-y-1.5 text-xs text-ink-700 dark:text-ink-300">
                  <div className="flex justify-between">
                    ...
                    <strong className="font-mono text-amber-600 dark:text-amber-400">GPA 5.00 / 5.00</strong>
                  </div>
                  <div className="flex justify-between">
            ...
            <div className="mt-5 space-y-4">
              <div className="rounded-xl border border-line/70 bg-paper/60 p-4 dark:border-line-dark/70 dark:bg-slate-800/50">
                ...
                <p className="mt-2 text-justify text-xs leading-relaxed text-ink-600 dark:text-ink-300">
                  Conducted whole-genome assembly scaffolding, annotation, mitogenomics, and population genomics of <span className="italic">Tor tor</span> and <span className="italic">Tenualosa ilisha</span> across regional aquatic ecosystems.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-line/70 bg-paper/60 p-4 dark:border-line-dark/70 dark:bg-slate-800/50">
                ...
                <p className="mt-2 text-justify text-xs leading-relaxed text-ink-600 dark:text-ink-300">
                  Designed an InfoNCE-aligned cross-modal foundation model framework leveraging DNABERT-2 and ESM-2 for candidate plastic-degrading gene discovery in bacterial genomes.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mt-10 rounded-2xl border border-line/80 bg-white/75 p-6 shadow-sm backdrop-blur-md dark:border-line-dark/80 dark:bg-slate-900/60 sm:p-8">
        ...
        <p className="mt-4 text-justify text-sm leading-relaxed text-ink-700 dark:text-ink-200 sm:text-base sm:leading-8">
          ...
          modern sequence-representation learning. I am particularly interested in the point where
          these two traditions meet: using foundation models trained on massive biological sequence
          corpora (DNABERT-2, ESM-2) to complement, rather than replace, the careful dataset
          curation and evolutionary reasoning that population genetics and mitogenomics demand.
        </p>
      </div>
      ...
      <div className="mt-10 rounded-2xl border border-line/80 bg-gradient-to-br from-white/80 via-white/60 to-bio-cyan/5 p-6 shadow-sm backdrop-blur-md dark:border-cyan-500/30 dark:from-slate-900/80 dark:via-slate-900/60 dark:to-cyan-950/20 sm:p-8">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-ink-500 dark:text-cyan-300/80">
              Topics of interest for prospective doctoral supervisors and academic collaborators:
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          {futureDirections.map((item, idx) => (
            ...
            >
              <CheckCircle2 size={16} className="mt-0.5 shrink-0 text-bio-cyan dark:text-cyan-400" />
